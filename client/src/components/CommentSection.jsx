...
const CommentSection = ({postId}) => {
    ...
    <div className='max-w-2xl mx-auto w-full p-3'>
        ...
        {currentUser && (
            <form onSubmit={submitHandler} className='border border-teal-500 rounded-md p-3'>
        ...
        {comments.length === 0 ? (
            ...
            {
                comments.map(comment =>(
                    <Comment key={comment._id} comment={comment} onLike={likeHandler} onEdit={editHandler} onDelete={(commentId)=> {
                        setshowModel(true)
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <div className='flex justify-center gap-4'>
              <Button color='failure' onClick={() => deleteHandler(commentToDelete)} >Yes, I'm  sure</Button>
